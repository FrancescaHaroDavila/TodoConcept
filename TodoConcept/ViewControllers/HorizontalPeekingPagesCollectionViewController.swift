...
class HorizontalPeekingPagesCollectionViewController: UICollectionViewController {
  ...
  private var indexOfCellBeforeDragging = 0
    ...
    private func configureCollectionViewLayoutItemSize() {
        ...
        collectionViewFlowLayout.itemSize = CGSize(width: collectionViewLayout.collectionView!.frame.size.width - inset * 2, height: collectionViewLayout.collectionView!.frame.size.height - inset/2)
